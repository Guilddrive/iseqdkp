...
set_permission_0644("/var/www/vhosts/at.guilddrive.de/$subdomain/config.php"); //=> run
set_permission_0777("/var/www/vhosts/at.guilddrive.de/$subdomain/data"); //=> run
...
$sql = "insert " . $var . "_users (user_id, username, user_password, user_lang, user_email, user_active, rules, user_style) values ('1', '" . $admin_user_var . "', '" . $sqlpass . "', 'german', '" . $sqlmail . "', '1', '0', '1')";
